...
//    [self setFrame:CGRectMake(0, 60, theView.frame.size.width, theView.frame.size.height-60)];
	[self setFrame:CGRectMake(0, 60, SCREEN_WIDTH, theView.frame.size.height-60)];
